...
Route::get('/speaking/video-call', [SpeakingVideoCallController::class, 'index'])->name('speaking.video-call')->middleware('auth');
Route::get('/speaking/video-call/interface', [SpeakingVideoCallController::class, 'status'])->name('speaking.video-call.status')->middleware('auth');
Route::post('/speaking/video-call/heartbeat', [SpeakingVideoCallController::class, 'heartbeat'])->name('speaking.video-call.heartbeat')->middleware('auth');
Route::post('/speaking/video-call/random', [SpeakingVideoCallController::class, 'joinRandomQueue'])->name('speaking.video-call.random')->middleware('auth');
Route::delete('/speaking/video-call/random', [SpeakingVideoCallController::class, 'cancelRandomQueue'])->name('speaking.video-call.random.cancel')->middleware('auth');
Route::post('/speaking/video-call/friends/{user}', [SpeakingVideoCallController::class, 'inviteFriend'])->name('speaking.video-call.friends.invite')->middleware('auth');
Route::post('/speaking/video-call/sessions/{videoCallSession}/accept', [SpeakingVideoCallController::class, 'accept'])->name('speaking.video-call.sessions.accept')->middleware('auth');
Route::post('/speaking/video-call/sessions/{videoCallSession}/decline', [SpeakingVideoCallController::class, 'decline'])->name('speaking.video-call.sessions.decline')->middleware('auth');
Route::post('/speaking/video-call/sessions/{videoCallSession}/leave', [SpeakingVideoCallController::class, 'leave'])->name('speaking.video-call.sessions.leave')->middleware('auth');
